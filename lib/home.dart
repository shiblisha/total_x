...
class _HomeState extends State<Home> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: Text(
            'Select Image From',
            style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Color(0xff004B59)),
          ),
          content: SingleChildScrollView(  // Add SingleChildScrollView
            child: Container(
              constraints: BoxConstraints(maxHeight: mheight * 0.1), // Set maximum height
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  GestureDetector(onTap: (){getCameraImage();},
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Icon(Icons.camera_alt, size: 30, color: Color(0xff004B59)),
                        SizedBox(width: mwidth * 0.02),
                        Text("Camera", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Color(0xff004B59)))
                      ],
                    ),
                  ),
                  SizedBox(height: mheight*0.026,),
                  GestureDetector(onTap: (){getGalleryImage();},
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: mwidth * 0.02),
                        Text("Gallery", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Color(0xff004B59)))
                      ],
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(resizeToAvoidBottomInset: false,
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Enter User\nDetails!",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24,color:Color(0xff004B59)),),
              ),
                  ...
                  children: [
                    Center(
                      ...
                      child: Container(
                        height: mheight*0.18,
                        width: mwidth*0.4,
                        decoration: BoxDecoration(color:Color(0xff004B59),borderRadius: BorderRadius.circular(100)),
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(keyboardType: TextInputType.number,
                              controller:age, validator: (value) {
                              if (value == null || value.isEmpty) {
                                return 'Field Should Not Be Empty';
                              }
                              return null;
      ...
      Padding(
          padding:  EdgeInsets.only(top: mheight*0.05,left: mwidth*0.75),
          child: Card(
            child: Container(
            height: mheight * .10,
            width: mwidth * .2,
